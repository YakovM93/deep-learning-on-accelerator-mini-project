...
if __name__ == "__main__":
    ...
    # Split train into validation and training 80-20 ratio
    ...
    # latent_dim in the assignment should be 128
    latent_dim =args.latent_dim
    ## Initialize model
    encoder = vae.EncoderCNN(input_shape[0], latent_dim)
    decoder = vae.DecoderCNN(latent_dim, input_shape[0])
    ae = vae.VAE(encoder, decoder,input_shape , hp['z_dim'])
